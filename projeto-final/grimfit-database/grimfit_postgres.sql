...
CREATE TABLE usuarios (
    ...
    preferencias_definidas BOOLEAN DEFAULT FALSE,
...
-- ============================================================
-- 22. PRODUTOS x ESTILOS
-- ============================================================

CREATE TABLE produto_estilos (
    produto_id INT NOT NULL,
...
-- ============================================================
-- 23. PREFERÊNCIAS DE ESTILO DOS USUÁRIOS
-- ============================================================

CREATE TABLE usuario_estilos_preferidos (
    usuario_id INT NOT NULL,
    estilo_id INT NOT NULL,
...
-- ============================================================
-- 24. FUNÇÃO PARA ATUALIZAR updated_at
-- ============================================================
...
CREATE INDEX idx_variacoes_produto
ON variacoes_produto(produto_id);

CREATE INDEX idx_favoritos_produto
ON favoritos(produto_id);

CREATE INDEX idx_itens_carrinho_carrinho
ON itens_carrinho(carrinho_id);

CREATE INDEX idx_itens_carrinho_variacao
ON itens_carrinho(variacao_id);
...
CREATE INDEX idx_rastreamentos_pedido
ON rastreamentos(pedido_id);

CREATE INDEX idx_historico_rastreamento
ON historico_rastreamento(rastreamento_id);
...
CREATE INDEX idx_tickets_usuario
ON tickets(usuario_id);

CREATE INDEX idx_mensagens_ticket_ticket
ON mensagens_ticket(ticket_id);

CREATE INDEX idx_mensagens_ticket_usuario
ON mensagens_ticket(usuario_id);
...
CREATE INDEX idx_produto_estilos_estilo
ON produto_estilos(estilo_id);

CREATE INDEX idx_usuario_estilos_estilo
ON usuario_estilos_preferidos(estilo_id);
